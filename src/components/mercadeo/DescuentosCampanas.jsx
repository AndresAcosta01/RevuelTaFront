...
const DescuentosCampanas = () => {
    ...
    useLayoutEffect(() => {
        ...
        return () => {
            bootstrap.media = "not all"
        }
    }, [])

    const handleVerHistorial = () => {
        setModalActiva("historial")
    }

    const handleVerTodasCampanas = () => {
        setModalActiva("campanas")
    }

    const handleVerOfertas = () => {
        setModalActiva("ofertas")
    }
        ...
        <div className={`container py-4 ${styles.root}`}>
            ...
            <div className="row g-4">
                ...
                <div className="col-lg-4">
                    ...
                    <CampanasActivas
                        onVerTodas={handleVerTodasCampanas}
                    />
